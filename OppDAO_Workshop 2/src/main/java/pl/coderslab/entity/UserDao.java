...
public class UserDao {
    ...
    // UserDao - zapisywanie nowego obiektu do bazy danych
    ...
    // UserDao - wczytywanie obiektu z bazy danych
    ...
    // UserDao - wczytanie wszystkich użytkowników
    public User[] findAll() {
        try (Connection connection = DbUtil.getConnection()) {
    ...
    // metoda pomocnicza, która poprzez kopiowanie tablic pozwala poradzić
    // sobie ze zwiększającym rozmiarem danych
